#!/usr/bin/python3  
# -*- coding: utf-8 -*-
# @File    : 20200823_4周_陈宝顺.py
# @Author  : Baoshun.Chin
# @Time    : 2020-09-15 22:20
# @Site    : 
# @version : V1.0
...
class Manager():
    ...
    def add_student(self):
       ...
       #  for i in self.students_dict.values():
       #      if stu_id == i['id']:
       #          print("该学号已经存在，请重新操作！！！")
       ...
       #
       # # 2.2.2字典新增数据
       #  self.students_dict['name'] = stu_name  # 如果name存在赋值修改，如果name不存在则赋值新增“name”这个变量
       #  self.students_dict['id'] = stu_id
       #  self.students_dict['score'] = stu_score
       #
       # # 2.2.3列表追加字典数据
       #  self.students_dict.append(self.students_dict)
